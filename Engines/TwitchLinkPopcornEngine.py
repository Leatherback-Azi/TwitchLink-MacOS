...
class TwitchDownloader:
    ...
    def encoder(self):
        try:
            ...
            self.process = subprocess.Popen([self.ffmpeg, "-y", "-i", self.data_path + "/" + "index-dvr.m3u8", "-c", "copy", self.file_path]
            ...
            self.cancel = True
            self.canceled = True
            print("Encode Error, TwitchLinkPopcornEngine.py (func - encoder, Approx. Ln.178)")
        self.removeTemporaryFiles()
        self.done = True
