...
class TwitchLink(QMainWindow, UiFiles.mainWindow):
    ...
    def onStart(self):
        # 'checkStatus' func replaced with MacOS Code
        if self.checkStatus_MacOS():
...
# func 'checkStatus' below is for 'WINDOWS OS ONLY'
    ...
    def checkStatus_MacOS(self):
        ...
        if status == "Server Error":
            ...
            # if self.db.updateNote == None or status == "Update Found" or "Update Required":
            return True
